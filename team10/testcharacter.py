...
class TestCharacter(CharacterEntity):
    ...
    def neighbors_of_8(self, x, y):
        ...
        return_list.extend(self.neighbors_of_4(x, y)) 
        #  Quadrant 1
    ...
    def a_star(self, start, goal):
        ...
        while not frontier.empty():
            ...
            curr_index = self.grid_to_index(x, y)
            # print("current index=")
            # print(curr_index)
            expanded_indices.append(curr_index)

            for next in self.neighbors_of_8(x, y):
